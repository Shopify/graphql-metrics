...
srcdir = /Users/chris/src/github.com/Shopify/graphql-metrics/vendor/bundle/ruby/2.6.0/gems/sorbet-0.4.5135/bin
topdir = /opt/rubies/2.6.5/include/ruby-2.6.0
hdrdir = $(topdir)
arch_hdrdir = /opt/rubies/2.6.5/include/ruby-2.6.0/x86_64-darwin18
PATH_SEPARATOR = :
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/opt/rubies/2.6.5
...
ldflags  = -L. -fstack-protector-strong -L/usr/local/lib -L/usr/local/opt/openssl/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/gdbm/lib
